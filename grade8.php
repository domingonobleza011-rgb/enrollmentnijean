    ...
    <body>
        ...
        <div class="container-fluid container1"> 
            <div class="row"> 
                <div class="col"> 
                    <div class="header">
                        <h1 class="text1">GRADE 8 ENROLLMENT </h1>
                    </div>
...
<hr style="background-color: black;">
        ...
        <div class="container">
            ...
            <h1 class="text-center">Grade 8 Enrollment Form</h1>
<hr style="background-color:black;">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button name="create_eight" type="submit" class="btn btn-primary">Submit Enrollment</button>
            </div> 
                </form> </div>
    </div>
</div>
