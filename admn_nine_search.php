                ...
                <tr>
                    ...
                    <td>    
                        ...
                        <form action="" method="post" style="display:inline;">
                            <input type="hidden" name="id_nine" value="<?= $view['id_nine'];?>">
                            <button class="btn btn-danger" type="submit" style="width: 90px; font-size: 17px; border-radius:30px;" name="delete_nine"> Archive </button>
                        </form>
                    </td>
                </tr>
    ...
    <?php if(is_array($view)) { ?>
        ...
        <tr>
            ...
            <td>    
                ...
                <form action="" method="post" style="display:inline;">
                    <input type="hidden" name="id_nine" value="<?= $row['id_nine'];?>">
                    <button class="btn btn-danger" type="submit" name="delete_nine"> Archive </button>
                </form>
