    ...
    <body>
        ...
        <div class="container-fluid container1"> 
            <div class="row"> 
                <div class="col"> 
                    <div class="header">
                        <h1 class="text1">GRADE 12 ENROLLMENT </h1>
                    </div>
                    <br>
        ...
        <div class="container">
            <h1 class="text-center">Grade 12 Enrollment Form</h1>
            <hr style="background-color:black;">
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="enrollmentModalTitle">Grade 12 Enrollment System</h5>
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="school_id" type="text" class="form-control mt-1" required>
                                ...
                                <div class="modal-footer mt-3">
                                    ...
                                    <button name="create_twelve" type="submit" class="btn btn-primary">Submit Grade 11 Enrollment</button>
                                </div> 
                            </form> 
                        </div>
                    </div>
