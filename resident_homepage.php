...
<html>
  ...
  .bg-warning-light { background-color: #fef9e7; }
    ...
    <body> 
        ...
        <?php 
            $view = $eusebia->view_announcement();
...
<div class="container mt-4">
  <div class="alert alert-primary border-0 shadow-sm py-4" role="alert">
    <h4 class="alert-heading"><i class="bi bi-megaphone-fill me-2"></i> ANNOUNCEMENT!</h4>
    <p class="mb-0">Welcome to the EUSEBIA PAZ ARROYO NATIONAL HIGH SCHOOL.</p>
    <p> 
                    <?= $view['event'];?> 
                </p>
