    ...
    <body>
        ...
        <div class="container-fluid container1"> 
            <div class="row"> 
                <div class="col"> 
                    <div class="header">
                        <h1 class="text1">GRADE 11 ENROLLMENT </h1>
                    </div>
                    <br>
        ...
        <div class="container">
            <h1 class="text-center">Grade 11 Enrollment Form</h1>
            <hr style="background-color:black;">
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="enrollmentModalTitle">Grade 11 Enrollment System</h5>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <select name="course" class="form-control border-primary" required>
                                                ...
                                                <option value="TVL-HE">TVL-HE (Home Economics)e</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="school_id" type="text" class="form-control mt-1" required>
                                ...
                                <div class="modal-footer mt-3">
                                    ...
                                    <button name="create_eleven" type="submit" class="btn btn-primary">Submit Grade 11 Enrollment</button>
                                </div> 
                            </form> 
                        </div>
                    </div>
