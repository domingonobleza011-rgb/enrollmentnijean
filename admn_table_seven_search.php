                ...
                <tr>
                    ...
                    <td>    
                        ...
                        <form action="" method="post" style="display:inline;">
                            <input type="hidden" name="id_seven" value="<?= $view['id_seven'];?>">
                            <button class="btn btn-danger" type="submit" style="width: 90px; font-size: 17px; border-radius:30px;" name="delete_seven"> Archive </button>
                        </form>
                    </td>
                </tr>
    ...
    <?php if(is_array($view)) { ?>
        ...
        <tr>
            ...
            <td> <?= $row['email'];?> </td>
                ...
                <form action="" method="post" style="display:inline;">
                    <input type="hidden" name="id_seven" value="<?= $row['id_seven'];?>">
                    <button class="btn btn-danger" type="submit" name="delete_seven"> Archive </button>
                </form>
